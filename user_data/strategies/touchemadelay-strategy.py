...
class TouchEmaDelayStrategy(IStrategy):

    timeframe = "3m"

    buy_ema_period = IntParameter(40, 100, default=50, space="buy")
    buy_bars_delay = IntParameter(60, 120, default=90, space="buy")

    sell_ema_period = IntParameter(40, 100, default=50, space="sell")
    sell_bars_delay = IntParameter(60, 120, default=90, space="sell")
